...
describe Slack::SlashCommand do
  it "creates from HTTP::Request" do
    request = HTTP::Request.new "POST", "/",
      body: "token=some_token&team_id=0&channel_id=1&channel_name=some_channel&user_id=2&user_name=some_user&command=cmd&text=txt&response_url=#{URI.encode_path("http://slack.com/response")}"
    ...
    command.response_url.should eq("http://slack.com/response")
  end
